...
def inquiry(request):
    if request.method == 'POST':
        ...
        contact = Contact(email=email,phone=phone,message=message,customer_need = customer_need,city = city,state = state,car_id = car_id,car_title = car_title, user_id = user_id,first_name = first_name,last_name =last_name,)
